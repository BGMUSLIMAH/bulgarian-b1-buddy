...
const GRAMMAR: Omit<CefrQuestion, "section">[] = [
  { id: "g1",  prompt: "Аз ___ студент.",                                 options: ["съм", "си", "е", "сме"],                  correct: 0 },
  { id: "g2",  prompt: "Тя ___ в София.",                                 options: ["живея", "живееш", "живее", "живеят"],     correct: 2 },
  { id: "g3",  prompt: "Вчера аз ___ хляб от магазина.",                  options: ["купувам", "купих", "ще купя", "купи"],    correct: 1 },
  { id: "g4",  prompt: "Утре ние ___ на лекар.",                          options: ["отидохме", "ще отидем", "отиваме", "отидете"], correct: 1 },
  { id: "g5",  prompt: "Това е ___ книга.",                               options: ["хубав", "хубава", "хубаво", "хубави"],    correct: 1 },
  { id: "g6",  prompt: "Книга___ е на масата.",                           options: ["а", "ът", "та", "то"],                    correct: 2 },
  { id: "g7",  prompt: "Стол___ е счупен.",                               options: ["а", "ът", "та", "то"],                    correct: 1 },
  { id: "g8",  prompt: "Дете___ спи.",                                    options: ["а", "ът", "та", "то"],                    correct: 3 },
  { id: "g9",  prompt: "___ да говоря с управителя.",                     options: ["Мога", "Знам", "Имам", "Съм"],            correct: 0 },
  { id: "g10", prompt: "Не ___ български добре.",                         options: ["говоря", "говориш", "говори", "говорят"], correct: 0 },
  { id: "g11", prompt: "Той ___ каза истината.",                          options: ["ме", "ми", "те", "го"],                    correct: 1 },
  { id: "g12", prompt: "Виждам ___ всеки ден.",                           options: ["го", "му", "си", "ти"],                    correct: 0 },
  { id: "g13", prompt: "Миналата година ние ___ в Пловдив.",              options: ["живеем", "живяхме", "ще живеем", "живеят"], correct: 1 },
  { id: "g14", prompt: "___ ли да дойдеш утре?",                          options: ["Можеш", "Знаеш", "Искаш", "Имаш"],         correct: 2 },
  { id: "g15", prompt: "Трябва ___ попълня формуляра.",                   options: ["да", "че", "и", "за"],                     correct: 0 },
];
